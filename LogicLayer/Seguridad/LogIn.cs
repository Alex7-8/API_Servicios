            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(msgResEjecucion))
                {
                    ...
                    if (O_TRANSACCION_ESTADO == 0)
                    {
                        ...
                        logInEntity.C_Descripcion_Roles = row["DESROLES"].ToString();
                        ...
                        token = jwtHelper.CreateToken(_ID_USUARIO, logInEntity.C_Descripcion_Roles, logInEntity.C_Id_Sucursal, logInEntity.C_Nombre_Sucursal, logInEntity.C_Logo_Sucursal, logInEntity.C_Nombre_Empleado, logInEntity.C_Foto_Empleado, logInEntity.C_Correo, secret);
                    ...
                    else
                    {
                        ...
                        if (puntoComaIndex != -1)
                        {
                            ...
                            string textoMensaje = "https://cafeinternet.srvcentral.com/#/Validar" + "?token=" + validartoken;
                            string mensajefinal = @"
                                                    <html>
                                                    <head>
                                                        <style>
