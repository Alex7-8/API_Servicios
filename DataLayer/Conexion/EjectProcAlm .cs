...
namespace DataLayer.Conexion
{
    public class EjectProcAlm
    {
        ...
        {
            public static string strSql = "Server = tcp:srvprci.database.windows.net,1433;Initial Catalog = DB_Pruebas_Servicio; Persist Security Info=False;User ID = DB_CI; Password=C@f3servi$;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout = 30";
